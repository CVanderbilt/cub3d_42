...
#    Updated: 2020/03/03 17:45:17 by eherrero         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAP_READER=srcs/errors.c srcs/map_reader_utils.c \
		   srcs/sprites_1.c srcs/sprites_2.c \
...
UTILS=srcs/ft_calloc.c srcs/ft_realloc.c srcs/ft_in_set.c srcs/ft_strcmp.c \
	  ...
	  srcs/ft_isspace.c srcs/get_next_line.c srcs/get_next_line_utils.c srcs/ft_putstr.c
